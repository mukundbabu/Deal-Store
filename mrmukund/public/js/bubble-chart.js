	...
	var tooltip = d3.select("body")
      ...
      node.append("circle")
		...
		.on("mouseover", function(d) {
			if (d.item.json_type == 1) {
				if (d.item.adddeal_text == 0) {
					
					//tooltip text
					tooltip.html("Store Name: "+"<b>"+d.item.store_name+"</b>"+"<br>"+
								"Category: "+"<b>"+d.item.category+"</b>"+"<br>"+
								"Type: "+"<b>"+d.item.type+"</b>"+"<br>"+
								"Start Date: "+"<b>"+d.item.start_date+"</b>"+"<br>"+
								"End Date: "+"<b>"+d.item.end_date+"</b>"+"<br>"+
								"Deal Description: "+"<b>"+d.item.deal_desc+"</b>"+"<br>"+
								"Store Url: "+"<b>"+d.item.store_url+"</b>"+"<br>"
					);
					
				} else {
					tooltip.html("<b>Click here to add a deal</b>");
				}
			} else {
				tooltip.html("Online:" + "<b>"+d.item.online_count +"</b>"+ " deals" + "<br>" + "Offline:" + "<b>"+(d.item.count - d.item.online_count) + "</b>"+" deals");
			}
